...
func! s:clr(fg, bg, ...)
  let l:fg = g:sakurine#palette[a:fg]
  let l:bg = g:sakurine#palette[a:bg]
...
let g:airline#themes#sakurine#palette = {
\   'normal': s:color_map(
\       ['bg', 'purple'],
\       ['fg', 'comment'],
\       ['fg', 'selection'],
...
if get(g:, 'airline#extensions#tabline#enabled', 0)
  let g:airline#themes#sakurine#palette.tabline = {
...
if exists('g:loaded_ctrlp')
  let g:airline#themes#sakurine#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
        \ s:clr('fg', 'selection'),
        \ s:clr('fg', 'comment'),
        \ s:clr('fg', 'purple'),
        \)
