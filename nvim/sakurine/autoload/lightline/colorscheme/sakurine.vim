" =============================================================================
" Filename: autoload/lightline/colorscheme/sakurine.vim
" Author: adamalbrecht
" License: MIT License
" Last Change: 2018/04/11
" =============================================================================

let s:black    = g:sakurine#palette.bg
let s:gray     = g:sakurine#palette.selection
let s:white    = g:sakurine#palette.fg
let s:darkblue = g:sakurine#palette.comment
...
if exists('g:lightline')
  ...
  let g:lightline#colorscheme#sakurine#palette = lightline#colorscheme#flatten(s:p)
