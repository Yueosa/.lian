...
vim.list_extend(specs, require("plugins.specs.comment"))
vim.list_extend(specs, require("plugins.specs.telescope"))
vim.list_extend(specs, require("plugins.specs.venv"))
vim.list_extend(specs, require("plugins.specs.wakatime"))
