...
Item {
    ...
    Text {
        ...
        text: "没有新通知"
        font.pixelSize: Sizes.font.xl; font.bold: true; color: theme.subtext
    }
        ...
        Repeater {
            ...
            delegate: Item {
                ...
                Rectangle {
                    id: hoverBg
                    anchors.centerIn: parent
                    width: parent.width; height: parent.height; radius: Sizes.rounding.normal
                    ...
                    RowLayout {
                        ...
                        Text { text: getAppName(modelData); font.bold: true; font.pixelSize: Sizes.font.body; color: theme.text; Layout.fillWidth: true }
