...
WidgetPanel {
    ...
    Rectangle {
        ...
        ColumnLayout {
            anchors.fill: parent; anchors.margins: 16; spacing: Sizes.spacing.md
            ...
            RowLayout {
                ...
                Text { 
                    ...
                    font.bold: true; font.pixelSize: Sizes.font.body; color: theme.text; elide: Text.ElideRight; Layout.fillWidth: true 
                }
                Text { 
                    text: root.defaultSink ? Math.round(root.defaultSink.audio.volume * 100) + "%" : "0%"
                    font.bold: true; font.pixelSize: Sizes.font.body; color: theme.primary 
                }
            }
    ...
    Text { text: "应用程序"; font.pixelSize: Sizes.font.lg; color: theme.subtext; font.bold: true; Layout.topMargin: 12 }

    ListView {
        id: appList // 给 ListView 起个 id 方便滚轮调用
        Layout.fillWidth: true; Layout.fillHeight: true
        clip: true; spacing: Sizes.spacing.md;
        ...
        delegate: Rectangle {
            ...
            radius: Sizes.rounding.normal; color: "transparent"
            border.width: 1; border.color: "transparent" 
            PwObjectTracker { objects: [ appNode ] }

            RowLayout {
                anchors.fill: parent; anchors.margins: 14; spacing: Sizes.spacing.l
                ...
                ColumnLayout {
                    Layout.fillWidth: true; spacing: Sizes.spacing.s
                    RowLayout {
                        Layout.fillWidth: true
                        Text { text: appNode.properties["application.name"] || appNode.name; font.bold: true; font.pixelSize: Sizes.font.lg; color: itemTheme.text; elide: Text.ElideRight; Layout.fillWidth: true }
                    }
                    ...
                    Item {
                        ...
                        Rectangle {
                            ...
                            width: parent.width; height: 6; radius: Sizes.rounding.xs
                            color: Qt.rgba(itemTheme.text.r, itemTheme.text.g, itemTheme.text.b, 0.1)
                            Rectangle { height: parent.height; width: parent.width * appNode.audio.volume; radius: Sizes.rounding.xs; color: itemTheme.primary }
                        }

                        Rectangle {
                            width: 6; height: 16; radius: Sizes.rounding.xs; color: itemTheme.text 
                            ...
                            Item {
                                ...
                                Rectangle {
                                    anchors.fill: parent; radius: Sizes.rounding.large; color: itemTheme.primary; rotation: 45 
                                    Rectangle { width: 16; height: 16; x: 16; y: 16; color: parent.color }
                                }
                                Text { anchors.centerIn: parent; text: Math.round(appNode.audio.volume * 100); color: itemTheme.surface; font.pixelSize: Sizes.font.xsm; font.bold: true }
                            }
                        }
