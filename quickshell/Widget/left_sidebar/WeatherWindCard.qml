...
WeatherInsightCard {
    ...
    readonly property real speedNumberSize: Math.round(width * 0.235)
    readonly property real speedUnitSize: Math.round(width * 0.10)
    ...
    Row {
        ...
        anchors.topMargin: Math.round(24 * root.uiScale)
    ...
    Item {
        id: arrowLayer
        width: Math.round(176 * root.uiScale)
        height: Math.round(176 * root.uiScale)
    ...
    Item {
        ...
        anchors.topMargin: Math.round(56 * root.uiScale)
        anchors.bottomMargin: Math.round(30 * root.uiScale)
        z: 2
