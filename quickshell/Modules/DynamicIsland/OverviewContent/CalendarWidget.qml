    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            component NavBtn : Rectangle {
                ...
                Layout.preferredWidth: 42; Layout.preferredHeight: 36; radius: Sizes.rounding.xl
                color: Colorscheme.surface_container_highest
                ...
                Repeater {
                    ...
                    Item {
                        ...
                        Text { 
                            ...
                            color: Colorscheme.on_surface_variant; font.family: Sizes.fontFamily; font.pixelSize: Sizes.font.md; font.bold: true 
                        }
                    }
                }
            }
            Rectangle { Layout.fillWidth: true; Layout.preferredHeight: 2; color: Colorscheme.surface_container_highest; radius: Sizes.rounding.hairline }
        }
            ...
            Repeater {
                ...
                Item {
                    ...
                    Text {
                        anchors.centerIn: parent
                        text: model.dayText
                        font.family: Sizes.fontFamily; font.pixelSize: Sizes.font.lg; font.bold: model.isToday
