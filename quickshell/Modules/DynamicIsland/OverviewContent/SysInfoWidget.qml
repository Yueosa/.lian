    ...
    RowLayout {
        ...
        Item {
            ...
            Image {
                id: avatarImg
                anchors.fill: parent
                source: "file://" + Quickshell.shellDir + "/assets/avatar.jpg"
            ...
            Rectangle {
                id: mask
                anchors.fill: parent; radius: Sizes.rounding.bubble; visible: false; color: Qt.rgba(Colorscheme.shadow.r, Colorscheme.shadow.g, Colorscheme.shadow.b, 1.0)
            }
            OpacityMask {
                anchors.fill: parent; source: avatarImg; maskSource: mask
            }
            Rectangle {
                anchors.fill: parent; radius: Sizes.rounding.bubble; color: "transparent"
            }
        }
