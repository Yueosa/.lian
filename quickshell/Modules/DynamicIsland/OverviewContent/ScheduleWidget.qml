...
Item {
    ...
    Rectangle {
        ...
        Text { anchors.centerIn: parent; text: "Time"; color: Colorscheme.on_surface_variant; font.pixelSize: Sizes.font.xsm; font.bold: true; font.family: Sizes.fontFamily }
    ...
    Item {
        ...
        Row {
            ...
            Repeater {
                model: root.headers
                Rectangle { width: root.cellW; height: root.headerH; color: "transparent"; Text { anchors.centerIn: parent; text: modelData; color: Colorscheme.on_surface_variant; font.pixelSize: Sizes.font.xsm; font.bold: true; font.family: Sizes.fontFamily } }
            }
        }
    }
    ...
    Item {
        ...
        Column {
            ...
            Repeater {
                ...
                Rectangle { width: root.timeW; height: root.cellH; color: "transparent"; Text { anchors.centerIn: parent; text: modelData.replace(" - ", "\n"); color: Colorscheme.outline; font.pixelSize: Sizes.font.hairline; font.family: Sizes.fontFamily; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter } }
            }
        }
    }
        ...
        GridLayout {
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    Layout.fillWidth: true; Layout.fillHeight: true; radius: Sizes.rounding.small
                    ...
                    Text {
                        ...
                        font.pixelSize: Sizes.font.xs; font.bold: !modelData.isEmpty; font.family: Sizes.fontFamily; horizontalAlignment: Text.AlignHCenter; verticalAlignment: Text.AlignVCenter; wrapMode: Text.WordWrap; elide: Text.ElideRight
                    }
                }
            }
        }
