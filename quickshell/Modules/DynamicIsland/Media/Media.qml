...
Item {
    ...
    readonly property string lyricsScriptPath: Qt.resolvedUrl("../../../scripts/lyrics_fetcher.py").toString().replace("file://", "")

    Process {
        id: lyricsProc
        running: false
        command: ["python3", root.lyricsScriptPath, root.title, root.artist]
    ...
    Rectangle {
        ...
        Rectangle { anchors.fill: parent; color: Qt.rgba(Colorscheme.shadow.r, Colorscheme.shadow.g, Colorscheme.shadow.b, 0.50) }
        ...
        Rectangle {
            ...
            anchors.margins: 16
            width: 36; height: 36; radius: Sizes.rounding.xl
        ...
        Item {
            ...
            Item {
                ...
                Rectangle {
                    width: 120; height: 120; radius: width / 2; color: "transparent"; anchors.centerIn: parent
                    Image {
                    ...
                    Text { anchors.centerIn: parent; text: "🎵"; font.pixelSize: Sizes.font.h5b; visible: root.artUrl === "" }
                }
            }
                ...
                layer.effect: OpacityMask {
                    maskSource: LinearGradient {
                        ...
                        gradient: Gradient {
                            ...
                            GradientStop { position: 0.25; color: Qt.rgba(Colorscheme.shadow.r, Colorscheme.shadow.g, Colorscheme.shadow.b, 1.0) }      
                            GradientStop { position: 0.75; color: Qt.rgba(Colorscheme.shadow.r, Colorscheme.shadow.g, Colorscheme.shadow.b, 1.0) }      
        ...
        ColumnLayout {
            ...
            Item {
                ...
                ColumnLayout {
                    ...
                    Item {
                        ...
                        // 1. 未播放部分 (加粗直线，带圆角和间隙)
                        Rectangle {
                            height: 6; radius: Sizes.rounding.xs  // 【加粗】：线宽统一为 6
            ...
            RowLayout {
                Layout.fillWidth: true; Layout.alignment: Qt.AlignHCenter; spacing: Sizes.spacing.blockPlus; Layout.maximumHeight: 60 
